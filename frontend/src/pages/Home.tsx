...
export default function LandingPage() {
  ...
  return (
    <>
      <SEO
        title="LikAI - AI-Powered Aquaculture Biosecurity | Prevent Disease Outbreaks & Boost Shrimp Farm Profits"
        description="Transform your shrimp farm with LikAI's AI-driven biosecurity platform. Prevent costly disease outbreaks, optimize yields, and save up to 75% on operational costs. BFAR GAqP aligned. Start your free analysis today."
              ...
              <div className="flex flex-col items-center gap-8 text-center sm:gap-12">
                ...
                <header className="relative mx-auto max-w-4xl">
                  ...
                  <p className="mb-6 text-sm leading-relaxed text-gray-600 sm:mb-8 sm:text-base lg:text-lg">
                    Safeguard your shrimp farm with AI-driven biosecurity,
                    aligned with Philippine BFAR GAqP standards, to minimize
                    disease risk and maximize your harvest potential.
                  </p>
                  <nav
            ...
            <div className="container mx-auto max-w-7xl px-4 text-center sm:px-6 md:px-8 lg:px-6">
              <header className="mb-12">
                ...
                <p className="mx-auto max-w-2xl px-2 text-base text-gray-600 sm:px-0 sm:text-lg">
                  Likai's AI guides your farm to adopt precise Good Aquaculture
                  Practices (GAqP), preventing costly losses and maximizing
                  resource efficiency to boost your yields and profits.
                </p>
              </header>
                  ...
                  <Card className="h-full border-0 bg-gradient-to-br from-orange-50/80 to-orange-50/40 shadow-lg transition-all duration-300 hover:from-orange-50 hover:to-orange-100/60">
                    <CardContent className="flex h-full min-h-[280px] flex-col justify-center p-8 text-center">
                      ...
                      <p className="mb-4 text-gray-600">
                        ...
                        market opportunities and enhancing your farm's
                        reputation.
                      </p>
                    </CardContent>
                  </Card>
            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-6">
              ...
              <article className="mb-16 grid grid-cols-1 items-center gap-8 sm:mb-20 sm:gap-12 lg:grid-cols-2">
                <header className="order-2 lg:order-1">
                  ...
                  <p className="mb-6 text-base leading-relaxed text-gray-600">
                    ...
                    with intuitive visual guides that feel like an expert by
                    your side. Get detailed, prioritized action plans with
                    progress tracking.
                  </p>
                          ...
                          <div className="rounded-lg border-l-4 border-green-500 bg-green-50 p-2.5">
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="mb-1 text-xs text-gray-700">
                                  Turn on backup aerators - all 3 units
                                  activated
                                </div>
                                <div className="flex items-center space-x-2">
              ...
              <article className="mb-16 grid items-center gap-8 sm:mb-20 sm:gap-12 lg:grid-cols-2">
                ...
                <header>
                  ...
                  <p className="mb-6 text-base leading-relaxed text-gray-600">
                    Get instant, expert-level guidance on your farm's
                    biosecurity and GAqP challenges with our intelligent AI
                    assistant. From routine questions to emergency situations,
              ...
              <article className="grid grid-cols-1 items-center gap-8 sm:gap-12 lg:grid-cols-2">
                ...
                <header className="order-2 lg:order-2">
                  ...
                  <p className="mb-6 text-base leading-relaxed text-gray-600">
                    Access comprehensive, GAqP-aligned aquaculture resources
                    that empower farmers to solve challenges confidently and
                    independently.
                  </p>
            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-6">
              <header className="mb-12 text-center sm:mb-16">
                ...
                <p className="mx-auto mb-8 max-w-2xl px-2 text-base text-gray-600 sm:px-0 sm:text-lg">
                  Choose the plan that fits your farm's biosecurity needs.
                        ...
                        <div className="space-y-3">
                          <div className="overflow-hidden rounded-lg border border-gray-200 transition-shadow hover:shadow-md">
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <Plus
                                  className={`h-4 w-4 flex-shrink-0 text-[#FF7F50] transition-transform ${
                                    expandedFaq === "general-1"
                                      ? "rotate-45"
                                      : ""
                                  }`}
                            ...
                            {expandedFaq === "general-1" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  ...
                                  continuously evolves with your farm's
                                  progress.
                                </p>
                              </div>
                            )}
                          ...
                          <div className="overflow-hidden rounded-lg border border-gray-200 transition-shadow hover:shadow-md">
                            ...
                            {expandedFaq === "general-2" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  The AI provides instant recommendations, and
                                  our GAqP action plans can help optimize your
                          ...
                          <div className="overflow-hidden rounded-lg border border-gray-200 transition-shadow hover:shadow-md">
                            ...
                            {expandedFaq === "general-3" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  Your farm's information is precious, and we
                                  keep it safe. Likai uses advanced digital
                                  'locks' (blockchain) and a secure, private
                                  system (ICP) to make sure your data is always
                                  protected, never seen by others, and
                          ...
                          <div className="overflow-hidden rounded-lg border border-gray-200 transition-shadow hover:shadow-md">
                            ...
                            {expandedFaq === "general-4" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  LikAI is designed for farmers, not
                                  technicians. Our interface is intuitive, and
                                  our AI chatbot speaks in plain language. We
                                  also provide step-by-step "How-To" guides for
                        ...
                        <div className="space-y-3">
                          <div className="overflow-hidden rounded-lg border border-gray-200 transition-shadow hover:shadow-md">
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <Plus
                                  className={`h-4 w-4 flex-shrink-0 text-[#3498DB] transition-transform ${
                                    expandedFaq === "pricing-1"
                                      ? "rotate-45"
                                      : ""
                                  }`}
                            ...
                            {expandedFaq === "pricing-1" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  Yes! You can switch between Free Tier,
                                  Business Plan, or Enterprise at any time.
                                  Changes take effect immediately, and billing
                                  is prorated for seamless transitions.
                                </p>
                              </div>
                            )}
                          </div>
                            ...
                            {expandedFaq === "pricing-2" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  ...
                                  Enterprise Plan provides centralized
                                  management with advanced analytics across all
                                  locations.
                                </p>
                              </div>
                            )}
                            ...
                            {expandedFaq === "pricing-3" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  ...
                                  self-service resources. Business Plan adds
                                  email support. Enterprise Plan includes
                                  priority phone support and a dedicated account
                                  manager.
                                </p>
                              </div>
                            )}
                          ...
                          <div className="overflow-hidden rounded-lg border border-gray-200 transition-shadow hover:shadow-md">
                            ...
                            {expandedFaq === "pricing-4" && (
                              <div className="border-t border-gray-100 px-4 pb-4">
                                <p className="pt-3 text-sm leading-relaxed text-gray-600">
                                  Our Enterprise Plan empowers you to
                                  effortlessly meet complex regulatory demands.
                                  It automatically generates detailed compliance
                                  reports, precisely formatted for BFAR
                                  accreditation and stringent international
                                  export standards (including HACCP and EU
                                  requirements), ensuring seamless market
                                  access.
                                </p>
                              </div>
                            )}
                    ...
                    <ol className="list-none space-y-6">
                      <li className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Share basic information about your farm size,
                            species, and current operations
                          </p>
                        </div>
                      </li>
