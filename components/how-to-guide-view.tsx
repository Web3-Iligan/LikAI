...
import { ArrowLeft, Send, Bot, User, Loader2, Lightbulb } from "lucide-react"
  ...
  useEffect(() => {
    ...
    const generateGuide = async () => {
      ...
      try {
        ...
        setGuideContent("Failed to generate the how-to guide. Please try again later.")
      } finally {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>AI-generated steps and interactive chat for this task.</CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* How-To Guide Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Generated Guide</h3>
            <Card className="min-h-[300px] flex flex-col">
              <ScrollArea className="flex-1 p-4">
                {loadingGuide ? (
                  ...
                  <div className="text-center text-gray-500 py-10">No guide available.</div>
                )}
              </ScrollArea>
            </Card>
          </div>
              ...
              <div className="border-t p-4">
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    disabled={!inputMessage.trim() || isTyping || loadingGuide || !guideContent}
                  >
